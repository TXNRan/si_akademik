   ...
   <div class="sidebar">
	...
	<section class="home-section">
	   ...
	   <div class="home-content">
		<h3>Data Pengguna SIAKAD</h3>
		<button type="button" class="btn btn-tambah">
		   <a href="datapengguna-entry.php">Tambah Data</a>
		</button>
		<button type="button" class="btn">
		   <a href="datapengguna-cetak.php">Cetak</a>
	    </button>
		<table class="table-data">
		   ...
		   <tbody>
              <?php 
                include '../koneksi.php';
                $sql = "SELECT * FROM tb_datapengguna";
			...
			echo "
			   ...
			   while($data = mysqli_fetch_assoc($result)) {
				echo "
				  ...
				  <td>$data[password]</td>
				  <td>
<a href=datapengguna-edit.php?id=$data[id]>Edit</a> | 
<a href=datapengguna-hapus.php?id=$data[id]>Hapus</a>
						  </td>
				   	</tr>
				   ";
			    }
